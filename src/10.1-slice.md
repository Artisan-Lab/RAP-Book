...
_4 = get_unchecked(move _5, move _6)                    [checkpoint (1)]
          ...
          VM  _4: term = _6.term + _5·size_of(Output), prov = (_6.alloc, _6.offset + _5·size_of(Output))

_3 = &(*_4)                                             [checkpoint (2)]
          check  Init(_4, T, 1)    ←  alloc(_4).initialized         Proved
          check  Align(_4, T)      ←  _6 aligned to T (from _1's data alloc), _5·size_of(T) keeps alignment   Proved
...
| (1) | `_6 = get_unchecked_mut(move _7, move _8)` | `InBound(_8, _7)` | `_6 = _8 + _7·size_of(Output)` | ← `InBound(_1, _2)` |
