...
entry   _1 = self (&[T]), _2 = index (I)
          ...
          caller contracts (asserted as facts):
            InBound(_1, _2)      →  _2 < len(_1)   (recorded as a path condition)
...
_4 = get_unchecked(move _5, move _6)                    [checkpoint (1)]
          ...
          check  InBound(_6, _5)   ←  _5 + 1 ≤ len(_6)   (SMT, from `_2 < len(_1)` and `_6` aliasing `_1`)   Proved
