...
_4 = get_unchecked(move _5, move _6)                    [checkpoint (1)]
          VM  _4: term = _6.term + _5·size_of(Output), prov = (_6.alloc, _6.offset + _5·size_of(Output))   (ReturnPointerAdd: base arg1, offset arg0)
...
| (1) | `_6 = get_unchecked_mut(move _7, move _8)` | `InBound(_8, _7)` | `_6 = _8 + _7·size_of(Output)` (ReturnPointerAdd: base `_8`, offset `_7`) | ← `InBound(_1, _2)` |
